def open_requirements_editor_BridgeConveyor(block_name, block_data, os, root, ctk, tk, clear_window, mod_folder, json, messagebox, создание_кнопки, threading, urllib):
                clear_window()
